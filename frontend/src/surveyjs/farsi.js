...
export const makeFarsi= (creator) =>{
    creator.locale = 'fa';
    creator.isRTL = true;
    SurveyCreator.editorLocalization.currentLocale = "fa";
    const farsiLocale = SurveyCreatorCore.getLocaleStrings("fa");
    replaceTranslations(farsiLocale)
